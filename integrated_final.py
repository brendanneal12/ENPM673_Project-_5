...
while ship_vid.isOpened():
    ...
    if ret == True:
        ...
        # on the first try, find the maximum height
        #if count == 1:
        #    for i in range(1, len(digit_vals)-2):
        #        if digit_vals[i-1] == '2' and digit_vals[i+1] == '8':
        #            first_digit = digit_vals[i]
        #    second_digit = digit_vals[0]
        #    maximum_height = first_digit + "." + str(second_digit)
        #    maximum_height = float(maximum_height)
